            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-xl text-muted-foreground">
                  Learn about Genesis, a modern programming language designed
                  for simplicity, performance, and developer happiness.
                </p>
              </div>
                ...
                <TabsContent value="overview" className="space-y-6">
                  <section className="prose dark:prose-invert max-w-none">
                    ...
                    <p className="leading-7 mb-4">
                      ...
                      designed to make developers more productive while writing
                      safe, maintainable, and efficient code. It combines the
                      best features of multiple programming paradigms, offering
                      a clean syntax, powerful type system, and excellent
                    ...
                    <ul className="list-disc pl-6 space-y-2 mb-6">
                      <li className="leading-7">
                        <strong>Elegant Syntax</strong>: Clean, readable code
                        with minimal boilerplate
                      </li>
                      <li className="leading-7">
                        <strong>Type Safety</strong>: Strong static typing with
                      ...
                      <li className="leading-7">
                        <strong>Performance</strong>: Comparable to C/C++ for
                        many workloads
                      </li>
                      <li className="leading-7">
                    ...
                    <p className="leading-7 mb-4">
                      ...
                      languages should be both powerful and enjoyable to use. We
                      focus on developer experience without compromising on
                      performance or safety. The language is designed to be
                      approachable for beginners while offering the depth and
                      flexibility that experienced developers demand.
                    </p>
                    ...
                    <div className="bg-muted p-6 rounded-lg my-8">
                      ...
                      <p className="mb-4">
                        Follow our installation guide to set up Genesis on your
                        machine and write your first program.
                      </p>
                      <Button>
                    ...
                    <p className="leading-7 mb-4">
                      ...
                      developers. Join us on GitHub, Discord, or the forums to
                      ask questions, share your projects, and contribute to the
...
func main() {
    ...
    println("Point: (\(point.x), \(point.y))")
                    ...
                    <div className="bg-muted p-6 rounded-lg my-8">
                      ...
                      <p className="mb-4">
                        Check out our examples repository for more complex code
                        samples and complete applications built with Genesis.
                      </p>
                  ...
                  <section className="prose dark:prose-invert max-w-none">
                    ...
                    <div className="bg-muted p-6 rounded-lg my-8">
                      ...
                      <p className="mb-4">
                        ...
                        properties, and examples, visit our complete API
                        reference.
                      </p>
                      <Button variant="outline">
